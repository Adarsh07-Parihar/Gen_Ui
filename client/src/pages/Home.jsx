    ...
    return (
        <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
                ...
                <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        {userData && <div className='hidden md:flex items-center gap-2 px-3 py-1.5
                         rounded-full bg-white/5 border border-white/10 text-sm cursor-pointer hover:bg-white/10
                        ...
                        >
                            ...
                            <div className='relative'>
                                <button className='flex items-center' onClick={() => setOpenProfile(!openProfile)}>
                                    <img src={userData.avatar || `https://ui-avatars.com/api/?name=${userData.name}`} alt="" className='w-9 h-9 rounded-full border
            ...
            <section className='pt-44 pb-32 px-6 text-center'>
                <motion.h1 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} className='text-5xl md:text-7xl font-bold tracking-tight'>
                ...
                >
                    ...
                    responsive, production-reasy website.
                </motion.p>
            ...
            {openLogin && <LoginModal open={LoginModal} onClose={() => setOpenLogin(false)} />}
