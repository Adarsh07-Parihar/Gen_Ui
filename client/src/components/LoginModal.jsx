...
const LoginModal = ({open, onClose}) => {
  ...
  return (
    <AnimatePresence>
    {open && <motion.div  className='fixed inset-0 z-100 flex items-center justify-center bg-black/80 backdrop-blur-xl px-4 in '
     initial={{opacity:0}} 
     animate={{opacity:1}}
     exit={{opacity:0}}
      onClick={onClose}
      ...
      >
        ...
        exit={{scale:0.9, opacity: 1, y:0}}
        transition={{duration:0.45, ease:"easeOut"}}
        className='relative w-100 mqax-w-md p-1px rounded-3xl bg-linear-to-br from-purple-500/40 via-blue-500/30 to-transparent'
        ...
        >
            <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
              ...
              className='absolute -top-32 w-80 -left-32 h-80 bg-purple-500/30 blur-[140px]'
              />
              <motion.div
               animate={{opacity:[0.2,0.35,0.2]}}
              transition={{duration:6, repeat:Infinity, delay:2}}
              className='absolute -bottom-32 w-80 -right-32 h-80 bg-blue-500/25 blur-[140px]'
              />
            </div>
            ...
            <div className='relative px-8 pt-14 pb-10 text-center'>
              ...
              >
                ...
                <img className='h-5 w-5' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcbdcygTuiOxXn4wxD2L82CI-VDHzX4edm1w&s" alt="" />
