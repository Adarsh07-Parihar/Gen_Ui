    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            {/* Dark Card Container Wrapper */}
            <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden w-full'>
              
              {/* Glow Effects */}
              <motion.div
                animate={{ opacity: [0.25, 0.4, 0.25] }}
                transition={{ duration: 6, repeat: Infinity }}
                className='absolute -top-32 w-80 -left-32 h-80 bg-purple-500/30 blur-[140px] pointer-events-none'
              />
              <motion.div
                animate={{ opacity: [0.2, 0.35, 0.2] }}
                transition={{ duration: 6, repeat: Infinity, delay: 2 }}
                className='absolute -bottom-32 w-80 -right-32 h-80 bg-blue-500/25 blur-[140px] pointer-events-none'
              />

              {/* Close Button - Now inside relative wrapper safely */}
              <button 
            ...
            </div> {/* /Ended dark card container wrapper properly here */}
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
